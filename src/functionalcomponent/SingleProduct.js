                            ...
                            product?.pic && <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel">
                                ...
                                <div className="carousel-inner">
                                    <div className="carousel-item active">
                                        <img src={`/img/${product.pic && product.pic[0]}`} height={500} className="d-block w-100" alt="..." />
                                    </div>
                                    {
                                        product.pic && product.pic.slice(1).map((item, index) => {
                                            return <div className="carousel-item" key={index}>
                                                <img src={`/img/${item}`} height={500} className="d-block w-100" alt="..." />
                                            </div>
                                        })
                                    }
                                </div>
                            ...
                            <tbody>
                                ...
                                </tr>
                                {
                                    product.stock ?
                                                ...
                                                <div className="row">
                                                    <div className="col-lg-3 col-md-6 text-center">
                                                        <div className="mb-3 btn-group">
                                                            ...
                                                            <p className="text-center text-bold fs-4" style={{ width: 60 }}>{qty}</p>
                                        ...
                                        <tr>
                                            <td colSpan={2}> <button className="btn btn-success" onClick={addToWishlist}><i className="fa fa-heart"></i>Add to Wishlist</button>
</td>
                                        </tr>
                                }
                                <tr>
