...
import{getNewsletter,addNewsletter}from'../store/ActionCreators/NewsletterActionCreators'
                ...
                <div className="container py-1">
                    <div className="row">
                        <div className="col-md-6">
                            <h1 className='text-light'><Link to="/" className='text-light'>Shop to basket</Link></h1>
